...
print(inp.shape)
# torch.save(net.state_dict(), 'mytrain.pt')
# the_model = Net()
# the_model.load_state_dict(torch.load('mytrain.pt'))
torch.save(net, 'mytrain.pt')
net_test=torch.load('mytrain.pt')


#net.save_state_dict('mytrain.pt')
